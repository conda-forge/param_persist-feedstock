...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/param_persist-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11058&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/param_persist-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `param_persist` can be installed with:

```
conda install param_persist
```

It is possible to list all of the versions of `param_persist` available on your platform with:
